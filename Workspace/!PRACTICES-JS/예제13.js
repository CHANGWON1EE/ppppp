...
cusName = prompt('고객명: ', '홍길동') || '미입력';
cusAge = prompt('나이 :', '25') || '미입력';
cusPhn = prompt('연락처: ', '010-1234-5678') || '미입력';
...
// if (cusName == '미입력' || cusAge == '미입력' || cusPhn == '미입력') {
//     alert('고객명, 나이, 연락처가 모두 입력되어야 합니다.')
// } else {
//     if(confirm(`입력하신 고객명은 ${cusName}님이고 나이는 ${cusAge}세, 연락처는 ${cusPhn} 입니다. 맞습니까?`)) {
//         alert('정보 확인에 감사드립니다. ^^')
//     } else {

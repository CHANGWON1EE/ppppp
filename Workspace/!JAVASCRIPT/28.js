...
console.log(data4 ?? 'value'); // 0
console.log(data5 ?? 'value'); // NaN

// null과 undefined 가 아닌 데이터의 검출

let input;

console.log(input !== null && input !== undefined ? input : 'value');

// null 병합 연산자를 통한 null과 undefined 가 아닌 데이터의 검출
console.log(input ?? 'value');

// null 병합 연산자 적용 시 괄호 없는 &&(and)와 ||(or) 연산자의 나열 금지
